        ...
        <section>
            <nav>
                <fieldset >
                    ...
                    <label for="estado">Estado</label>
                    <br><br>
                    <center><input class="button" type="submit" value="Modificar"></center>
                </fieldset> 
            </nav>
            <article>
                <center><label>Matricula: </label><input type="text" id="buscar" name="buscar"  ><hr><input class="button" type="submit" value="Buscar">
